...
def display_select_mode():
    ...
    """
    with st.sidebar:
        st.markdown("<span style='font-size:1.3em; font-weight:bold; color:black;'>利用目的</span>", unsafe_allow_html=True)
...
def display_initial_ai_message():
    ...
    st.markdown(
        """
        <div style='background-color:#FFF3E0; border-radius:6px; padding:12px; margin-top:10px;'>
            <span style='color:#EE7700; font-size:1.05em;'>具体的に入力したほうが期待通りの回答を得やすいです。</span>
        </div>
        """,
                ...
                # 「社内問い合わせ」の場合の表示処理
                    ...
                    if "file_info_list" in message["content"]:
                        ...
                        for file_info in message["content"]["file_info_list"]:
                            # 参照元のありかに応じて、適したアイコンを取得
                            # file_infoが"ファイル名（ページNo.n）"形式かどうかは後続で対応
